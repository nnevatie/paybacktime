/*
    ...
    OpenGL loader generated by glad 0.1.9a3 on Fri Jan  1 12:05:17 2016.
    ...
    Profile: core
    Extensions:
        GL_ARB_debug_output, GL_ARB_timer_query, GL_EXT_texture_filter_anisotropic
    Loader: No

    Commandline:
        --profile="core" --api="gl=3.2" --generator="c" --spec="gl" --no-loader --extensions="GL_ARB_debug_output,GL_ARB_timer_query,GL_EXT_texture_filter_anisotropic"
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&api=gl%3D3.2&extensions=GL_ARB_debug_output&extensions=GL_ARB_timer_query&extensions=GL_EXT_texture_filter_anisotropic
*/
